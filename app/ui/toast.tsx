...
export default function Toast() {
  ...
  return isHidden ? null : (
    <div className="sticky rounded-2xl w-11/12 md:w-[581px] h-40 md:h-[80px] p-0.5 z-10 bottom-10 left-0 right-0 mx-auto">
      <div className="rounded-[14px] w-full h-full bg-gray-50 border border-gray-200 flex flex-col md:flex-row items-center justify-center md:justify-between space-y-3 md:space-y-0 px-5">
